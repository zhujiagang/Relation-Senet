...
class Graph():
    ...
    def get_adjacency_matrix(self, labeling_mode=None):
        ...
        elif labeling_mode == 'spatialrelation':
            A = tools.get_spatial_relation_graph(num_node, self_link, inward, outward, neighbor)
        elif labeling_mode == 'completerelation2graph':
            A = tools.get_complete_relation_2_graph(num_node, self_link)
