...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='./config/st_gcn_relation/nturgbd-cross-view/test.yaml',
    ...
    parser.add_argument(
        '--weights',
        default="/data-sdb/data/jiagang.zhu/st-gcn-work/st-gcn-relation/work_dir/NTU-RGB-D/xview/ST_GCN_RELATION/epoch20_model.pt",
